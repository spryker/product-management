...
class GeneralTabInformationContentProvider extends AbstractGeneralTabContentProvider
{
    ...
    {
        return ['@ProductManagement/Product/_partials/general-tab-information.twig'];
    }
}
